...
try:
    ...
    from client import GanetiRAPIClient as GntRapiClient
...
class ClientWrapper:
    ...
    def _initialize_client(self):
        try:
            ...
            self.module.fail_json(
                msg=f"Failed to connect to GenetiRAPIClient, error: {e}"
            )
    ...
    def check_network_exists(self, network_name: str) -> bool:
        return network_name in self._client.network_service.get_network_names()
